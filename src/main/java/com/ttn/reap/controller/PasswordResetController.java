...
public class PasswordResetController {
    ...
    public ModelAndView processForgotPasswordForm(ModelAndView modelAndView, @RequestParam("email") String email,
        ...
        Employee employee = employeeService.findEmployeeByEmailId(email);
        if (employee == null) {
            ...
            employee1.setResetToken(UUID.randomUUID().toString());

            // Save token to database
            employeeService.updateEmployeePassword(employee1);
            ...
            passwordResetEmail.setTo(employee1.getEmail());
            passwordResetEmail.setSubject("Password Reset Request");
            passwordResetEmail.setText("To reset your password, click the link below:\n" + appUrl
                    + "/reset?token=" + employee1.getResetToken());
